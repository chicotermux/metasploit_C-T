...
| | \/| | | ___\ |- -|   /\    / __\ | -__/ | || | || | |- -|
|_|   | | | _|__  | |_  / -\ __\ \   | |    | | \__/| |  | |_
      |/  |____/  \___\/ /\ \\___/   \/     \__|    |_\  \___\'| lolcat
echo -e ' ....:::!!!! este script a sido creado por el chixo termux !!!!:::....'| lolcat
cd --
cd
cd $HOME
cd ~
...
echo "listo , ya se a instalado metasploit-framework , para empesar ponga msfconsole"
